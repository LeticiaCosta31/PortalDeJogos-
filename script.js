let url = "https://api.rawg.io/api/games?key=9f0aabf48f184d04ba05900ec2f4778e";
let video_url= "https://api.rawg.io/api/games/3498/movies?key=9f0aabf48f184d04ba05900ec2f4778e";
let creatorsUrl="https://api.rawg.io/api/creators?key=9f0aabf48f184d04ba05900ec2f4778e";
let plataformaUrl = "https://api.rawg.io/api/platforms?key=9f0aabf48f184d04ba05900ec2f4778e";
...
function inserirDados(resposta){
            ...
            for (let i=0; i<6; i++){
                ...
                `
                    <div class="Cards_lancamento">
                        ...
                        <img src="${x.results[i].image}" style="width:200px; heigth:150px;">
                        <ul>
    ...
    req.open("GET", "https://api.rawg.io/api/creators?key=9f0aabf48f184d04ba05900ec2f4778e");
    req.send();
    ...
    for (let i=0; i<3; i++){
        cardPlataforma.innerHTML+=`
                <div class="Card_Plataforma">
                    ...
                    <img src="${resposta.results[i].background_image}" style="width: 300px; height: 200px; padding:10px;">
                    <ul>
        ...
        if(req2.readyState==4){
            ...
            for(let i = 0; i < 4; i++){
                ...
                <div class="Cards_Publisher">
                    ...
                    <img src="${y.results[i].image_background}" alt="${y.results[i].name}" style="width: 300px; height: 200px; padding:10px;">
